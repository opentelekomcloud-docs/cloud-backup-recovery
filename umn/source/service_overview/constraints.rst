...
-  Only cloud server backups in the **Available** or **Locked** vaults can be used to create images.
...
-  When SDRS is used to set up disaster recovery for cloud servers, restorations can be performed at the disaster recovery site only after DR protection is disabled.
