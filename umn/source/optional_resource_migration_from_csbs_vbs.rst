...
(Optional) Resource Migration from CSBS/VBS
===========================================
...
During migration, CBR will automatically create vaults based on your historical resource types.
...
-  The vaults you have cannot be used for migration. Resources will be automatically migrated to system-created vaults.
...
#. Click **Migrate to CBR** in the upper right corner. Read the content in the displayed dialog box and click **OK**.
...
#. How Do I Delete Backups from the VBS Console?
...
#. What Can I Do If a Resource Has Been Associated with CSBS or VBS?
