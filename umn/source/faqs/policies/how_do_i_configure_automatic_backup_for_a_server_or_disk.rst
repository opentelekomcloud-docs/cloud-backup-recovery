...
#. Apply the policy you defined to the vault. The system will then back up the resources that are associated with the vault at the specified time and retains the backups based on the retention rule.
