...
| Permission               | API                                         | Action               | Dependencies          | IAM Project |
+==========================+=============================================+======================+=======================+=============+
| Replicating a checkpoint | POST /v3/{project_id}/checkpoints/replicate | cbr:vaults:replicate | ``-``                 | Y           |
+--------------------------+---------------------------------------------+----------------------+-----------------------+-------------+
| Creating a checkpoint    | POST /v3/{project_id}/checkpoints           | cbr:vaults:backup    | ecs:cloudServers:list | Y           |
|                          |                                             |                      |                       |             |
|                          |                                             |                      | evs:volumes:list      |             |
+--------------------------+---------------------------------------------+----------------------+-----------------------+-------------+
